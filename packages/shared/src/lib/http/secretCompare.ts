...
// leaks the matching prefix length through CPU timing. Callers guarding
// cross-tenant data with header secrets (e.g. the customer_accounts custom-domain
// routes and the shared `resolveRequestHostname` force-host override) MUST use
// this instead.
//
