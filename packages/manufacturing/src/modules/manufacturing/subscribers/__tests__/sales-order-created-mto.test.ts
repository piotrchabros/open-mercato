...
describe('manufacturing:sales-order-mto-draft subscriber', () => {
  beforeEach(() => {
  ...
  it('drafts a manufacturing order for every make-flagged line, skipping buy lines', async () => {
    isMtoAutoDraftEnabledMock.mockResolvedValue(true)
    ...
    expect(commandId).toBe('manufacturing.orders.create')
