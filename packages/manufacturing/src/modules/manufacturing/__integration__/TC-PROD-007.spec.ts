...
/**
 * TC-PROD-007: Manufacturing order shortage path (task 3.4) — releasing
 ...
 * (+activate), and manufacturing order via the API — no stock is ever
 * received for the BOM component, cleaning up fixtures in `finally`.
 */
test.describe('TC-PROD-007: Manufacturing order shortage path (no stock)', () => {
