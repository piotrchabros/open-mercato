 ...
 *
 * `manufacturing-downtime-reasons` is explicitly DEFERRED to a future OEE
 * extension (spec decision b) and is NOT declared here.
 *
 * The manage UI is the generic `dictionaries` module settings page
 * (`/backend/config/dictionaries`) — manufacturing does not build its own
 ...
 */
export const PRODUCTION_SCRAP_REASON_DICTIONARY_KEY = 'manufacturing-scrap-reasons'
