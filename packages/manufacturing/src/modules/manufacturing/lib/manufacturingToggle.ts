import { PRODUCTION_TOGGLE_ID } from './manufacturingToggleId.js'
...
/**
 * Server-side gate for the manufacturing module surface.
 *
 ...
 * rollout switch). It becomes visible only when the `manufacturing_enabled`
 ...
 */
export async function isManufacturingEnabledForTenant(tenantId: string | null | undefined): Promise<boolean> {
