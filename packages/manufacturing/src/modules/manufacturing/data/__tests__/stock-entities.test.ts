...
describe('StockItem entity', () => {
  it('maps to manufacturing_stock_items table', () => {
    const meta = metaFor(StockItem)
    expect(meta.tableName).toBe('manufacturing_stock_items')
  })
...
describe('StockBatch entity', () => {
  it('maps to manufacturing_stock_batches table', () => {
    const meta = metaFor(StockBatch)
    expect(meta.tableName).toBe('manufacturing_stock_batches')
  })
...
describe('StockMovement entity (append-only, decision h)', () => {
  it('maps to manufacturing_stock_movements table', () => {
    const meta = metaFor(StockMovement)
    expect(meta.tableName).toBe('manufacturing_stock_movements')
  })
...
describe('MaterialReservation entity', () => {
  it('maps to manufacturing_material_reservations table', () => {
    const meta = metaFor(MaterialReservation)
    expect(meta.tableName).toBe('manufacturing_material_reservations')
  })
