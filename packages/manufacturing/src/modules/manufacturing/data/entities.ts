...
export type ManufacturingOrderStatus =
  ...
  | 'closed'
  | 'cancelled'
export type ManufacturingOrderSourceType = 'sales_order' | 'mrp' | 'manual'
export type ManufacturingOrderOperationStatus = 'pending' | 'in_progress' | 'done'
export type ManufacturingReportType = 'partial' | 'final'
...
@Index({ name: 'manufacturing_work_centers_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
...
@Index({ name: 'manufacturing_boms_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Unique({
  name: 'manufacturing_boms_scope_version_unique',
...
@Entity({ tableName: 'manufacturing_bom_items' })
@Index({ name: 'manufacturing_bom_items_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_bom_items_bom_idx', properties: ['bomId'] })
export class ManufacturingBomItem {
  @PrimaryKey({ type: 'uuid', defaultRaw: 'gen_random_uuid()' })
  id!: string
...
@Entity({ tableName: 'manufacturing_routings' })
@Index({ name: 'manufacturing_routings_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Unique({
  name: 'manufacturing_routings_scope_version_unique',
  properties: ['tenantId', 'organizationId', 'productId', 'variantId', 'version'],
})
...
@Entity({ tableName: 'manufacturing_routing_operations' })
@Index({ name: 'manufacturing_routing_operations_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_routing_operations_routing_idx', properties: ['routingId', 'sequence'] })
...
@Entity({ tableName: 'manufacturing_planning_params' })
@Index({ name: 'manufacturing_planning_params_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Unique({
  name: 'manufacturing_planning_params_scope_unique',
...
// `manufacturing_stock_items`/`manufacturing_stock_batches` track on-hand quantity
// only (no valuation, fence j); `manufacturing_stock_movements` is append-only
...
@Entity({ tableName: 'manufacturing_stock_items' })
@Index({ name: 'manufacturing_stock_items_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Unique({
  name: 'manufacturing_stock_items_scope_product_unique',
  properties: ['tenantId', 'organizationId', 'productId', 'variantId'],
})
...
@Entity({ tableName: 'manufacturing_stock_batches' })
@Index({ name: 'manufacturing_stock_batches_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_stock_batches_stock_item_idx', properties: ['stockItemId'] })
@Unique({
  name: 'manufacturing_stock_batches_item_number_unique',
...
@Entity({ tableName: 'manufacturing_stock_movements' })
@Index({ name: 'manufacturing_stock_movements_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_stock_movements_product_idx', properties: ['productId', 'variantId'] })
@Unique({
  name: 'manufacturing_stock_movements_reverses_unique',
...
@Entity({ tableName: 'manufacturing_material_reservations' })
@Index({ name: 'manufacturing_material_reservations_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_material_reservations_stock_item_idx', properties: ['stockItemId'] })
...
// ---------------------------------------------------------------------------
// Manufacturing orders (spec § Status machine / Data Models, Phase 3).
//
// `ManufacturingOrderOperation`/`ManufacturingOrderMaterial` are SNAPSHOT rows
// (decision g): `release` copies the currently-active `RoutingOperation`/
// `ManufacturingBomItem` rows into these tables as independent copies. A later
...
@Index({ name: 'manufacturing_orders_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Unique({
  name: 'manufacturing_orders_scope_number_unique',
...
export class ManufacturingOrder {
  ...
  sourceType: ManufacturingOrderSourceType = 'manual'
...
@Entity({ tableName: 'manufacturing_order_operations' })
@Index({ name: 'manufacturing_order_operations_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_order_operations_order_idx', properties: ['orderId', 'sequence'] })
export class ManufacturingOrderOperation {
  ...
  status: ManufacturingOrderOperationStatus = 'pending'
...
@Entity({ tableName: 'manufacturing_order_materials' })
@Index({ name: 'manufacturing_order_materials_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_order_materials_order_idx', properties: ['orderId'] })
...
//
// `ManufacturingReport` is **append-only + storno** (decision h, same exemption
...
@Entity({ tableName: 'manufacturing_reports' })
@Index({ name: 'manufacturing_reports_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_reports_operation_idx', properties: ['orderOperationId'] })
@Unique({
  name: 'manufacturing_reports_reverses_unique',
...
export class ManufacturingReport {
  ...
  reportType!: ManufacturingReportType
...
@Entity({ tableName: 'manufacturing_mrp_runs' })
@Index({ name: 'manufacturing_mrp_runs_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
export class MrpRun {
  @PrimaryKey({ type: 'uuid', defaultRaw: 'gen_random_uuid()' })
  id!: string
...
@Entity({ tableName: 'manufacturing_mrp_suggestions' })
@Index({ name: 'manufacturing_mrp_suggestions_tenant_org_idx', properties: ['tenantId', 'organizationId'] })
@Index({ name: 'manufacturing_mrp_suggestions_run_idx', properties: ['runId'] })
@Index({ name: 'manufacturing_mrp_suggestions_status_idx', properties: ['tenantId', 'organizationId', 'status'] })
