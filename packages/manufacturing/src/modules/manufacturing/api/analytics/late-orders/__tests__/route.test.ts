...
describe('GET /api/manufacturing/analytics/late-orders scoping', () => {
  ...
  it('scopes the ManufacturingOrder query by tenantId and organizationId', async () => {
    const req = new NextRequest('http://localhost/api/manufacturing/analytics/late-orders')
