...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: translate('manufacturing.errors.stock_list_failed', 'Failed to load stock items.') },
      { status: 400 },
    )
  }
}
...
export const openApi: OpenApiRouteDoc = {
  tag: 'Manufacturing',
  summary: 'List manufacturing stock items',
  methods: {
    GET: {
      operationId: 'listManufacturingStock',
      summary: 'List manufacturing stock on-hand',
