...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: translate('manufacturing.errors.stock_movements_failed', 'Failed to load stock movements.') },
      { status: 400 },
    )
  }
}
...
export const openApi: OpenApiRouteDoc = {
  tag: 'Manufacturing',
  summary: 'List manufacturing stock movements',
  methods: {
    GET: {
      operationId: 'listManufacturingStockMovements',
