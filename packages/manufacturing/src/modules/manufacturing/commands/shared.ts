...
/**
 * Document-aggregate optimistic lock for `ManufacturingOrder` sub-resources
 ...
 */
export const PRODUCTION_ORDER_RESOURCE_KIND = 'manufacturing.order'

export async function enforceManufacturingOrderOptimisticLock(
