...
const seedScrapReasons: ModuleCli = {
  ...
  async run(rest) {
    ...
    if (!tenantId || !organizationId) {
      console.error('Usage: mercato manufacturing seed-scrap-reasons --tenant <tenantId> --org <organizationId>')
      return
    }
...
const manufacturingCliCommands = [seedScrapReasons]

export default manufacturingCliCommands
