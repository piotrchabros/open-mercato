 ...
 * (task 1.3). Work center options are loaded from /api/manufacturing/work-centers.
 */
    ...
    <div className="flex flex-col gap-3">
      {rows.length === 0 ? (
        <div className="rounded-md border border-dashed border-border p-4 text-sm text-muted-foreground">
          {t('manufacturing.routings.operations.empty', 'No operations yet. Add the first step.')}
        </div>
      ) : (
          ...
          {rows.map((row, index) => (
            <div key={index} className="grid grid-cols-12 items-center gap-2 rounded-md border border-border p-2">
              <div className="col-span-1">
                <Input
                  type="number"
                  aria-label={t('manufacturing.routings.operations.field.sequence', 'Seq.')}
                  placeholder={t('manufacturing.routings.operations.field.sequence', 'Seq.')}
                  value={row.sequence}
              ...
              <div className="col-span-3">
                <Input
                  aria-label={t('manufacturing.routings.operations.field.name', 'Operation name')}
                  placeholder={t('manufacturing.routings.operations.field.name', 'Operation name')}
                  value={row.name}
              ...
              <div className="col-span-3">
                ...
                >
                  <SelectTrigger aria-label={t('manufacturing.routings.operations.field.work_center_id', 'Work center')}>
                    <SelectValue placeholder={t('manufacturing.routings.operations.field.work_center_id', 'Work center')} />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="col-span-1">
                <Input
                  type="number"
                  aria-label={t('manufacturing.routings.operations.field.setup_time_minutes', 'Setup time (min)')}
                  placeholder={t('manufacturing.routings.operations.field.setup_time_minutes', 'Setup time (min)')}
              ...
              <div className="col-span-2">
                <Input
                  type="number"
                  aria-label={t('manufacturing.routings.operations.field.run_time_per_unit_seconds', 'Run time per unit (s)')}
                  placeholder={t('manufacturing.routings.operations.field.run_time_per_unit_seconds', 'Run time per unit (s)')}
              ...
              <div className="col-span-1 flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">
                  {t('manufacturing.routings.operations.field.is_reporting_point', 'Reporting point')}
                </span>
              </div>
              <div className="col-span-1 flex justify-end">
                <Button
                  ...
                  aria-label={t('manufacturing.routings.operations.remove', 'Remove')}
                >
      ...
      <div>
        <Button type="button" variant="outline" size="sm" onClick={addRow}>
          ...
          {t('manufacturing.routings.operations.add', 'Add operation')}
        </Button>
      </div>
    </div>
  )
