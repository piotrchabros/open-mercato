/**
 * Search indexing for the manufacturing module (task 6.2 — final sweep).
 *
 * Only `ManufacturingOrder` and `ManufacturingBom` are indexed (spec §
 ...
 * movements, manufacturing reports, material reservations, and MRP runs/
...
function assertTenantContext(ctx: SearchBuildContext): asserts ctx is SearchContext {
  if (typeof ctx.tenantId !== 'string' || ctx.tenantId.length === 0) {
    throw new Error('[search.manufacturing] Missing tenantId in search build context')
  }
}
...
export const searchConfig: SearchModuleConfig = {
  entities: [
    ...
    // =========================================================================
    {
      entityId: 'manufacturing:manufacturing_order',
      enabled: true,
      priority: 8,
      ...
      buildSource: async (ctx: SearchBuildContext): Promise<SearchIndexSource | null> => {
        ...
        return {
          ...
          links: [
            {
              href: `/backend/manufacturing/orders/${encodeURIComponent(String(record.id))}`,
              label: title,
              kind: 'primary',
            },
          ],
      ...
      resolveUrl: async (ctx: SearchBuildContext): Promise<string | null> => {
        ...
        if (!id) return null
        return `/backend/manufacturing/orders/${encodeURIComponent(String(id))}`
      },
      ...
      resolveLinks: async (ctx: SearchBuildContext): Promise<SearchResultLink[] | null> => {
        ...
        return [
          {
            href: `/backend/manufacturing/orders/${encodeURIComponent(String(id))}`,
            label: 'View',
            kind: 'primary',
          },
        ]
      ...
      aclFeatures: ['manufacturing.orders.view'],
    },
    ...
    // =========================================================================
    {
      entityId: 'manufacturing:manufacturing_bom',
      enabled: true,
      priority: 8,
      ...
      buildSource: async (ctx: SearchBuildContext): Promise<SearchIndexSource | null> => {
        ...
        return {
          ...
          links: [
            {
              href: `/backend/manufacturing/boms/${encodeURIComponent(String(record.id))}`,
              label: title,
              kind: 'primary',
            },
          ],
      ...
      resolveUrl: async (ctx: SearchBuildContext): Promise<string | null> => {
        const id = ctx.record.id
        if (!id) return null
        return `/backend/manufacturing/boms/${encodeURIComponent(String(id))}`
      },
      ...
      resolveLinks: async (ctx: SearchBuildContext): Promise<SearchResultLink[] | null> => {
        ...
        return [
          {
            href: `/backend/manufacturing/boms/${encodeURIComponent(String(id))}`,
            label: 'View',
            kind: 'primary',
          },
        ]
      ...
      aclFeatures: ['manufacturing.technology.view'],
    },
  ],
}
