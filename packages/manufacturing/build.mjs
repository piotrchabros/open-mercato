...
function resolveGeneratedImport(importPath, fileDir) {
  const targetPath = importPath.startsWith('entities/')
    ? join(distDir, 'generated', importPath, 'index.js')
    : join(distDir, 'generated', importPath + '.js')
